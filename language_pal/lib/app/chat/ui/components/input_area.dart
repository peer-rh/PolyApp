...
import 'package:poly_app/app/chat/features/get_answer_suggestion.dart';
...
class ChatInputAreaOld extends ConsumerStatefulWidget {
  ScenarioModel scenario;

  ChatInputAreaOld({Key? key, required this.scenario}) : super(key: key);

  @override
  ConsumerState<ChatInputAreaOld> createState() => _InputAreaState();
}

class _InputAreaState extends ConsumerState<ChatInputAreaOld> {
